  ...
  return (
    <>
      <TabContext value={value} >
        ...
        <TabPanel value="1" >
          <Box display="flex" flexWrap="wrap" justifyContent="center" className="teste">
            <ListaPostagem />
          </Box>
        </TabPanel>
        <TabPanel value="2" className="teste">
          <Typography variant="h5" gutterBottom color="textPrimary" component="h5" align="center" className="teste">Sobre-nós</Typography>
